      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          <div>
            ...
            <p className="text-gray-300 mb-4">
              Your ultimate destination for Supercross & Motocross racing
              content, stats, and betting with friends.
            </p>
          ...
          <div>
            ...
            <p className="text-gray-300 mb-4">
              Subscribe to get the latest news, race updates, and exclusive
              offers.
            </p>
            <form className="flex">
              <input
              ...
              <button
                type="submit"
                className="bg-primary text-white px-4 py-2 rounded-r hover:bg-opacity-90 transition-all"
        ...
        <div className="pt-8 border-t border-gray-700 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-300 text-sm mb-4 md:mb-0">
            © {new Date().getFullYear()} MXRaceHub. All rights reserved.
          </p>
          <div className="flex space-x-4">
            <a
              href="#"
