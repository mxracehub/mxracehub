...
Parents and guardians should also take steps to prevent minors from accessing gambling websites, such as:

- Using parental control software
- Monitoring internet usage
- Having open conversations about the risks of gambling
- Keeping account login details secure

## Support Resources

If you or someone you know is experiencing gambling-related problems, there are many resources available for support:

<div class="grid grid-cols-1 md:grid-cols-2 gap-6 my-8">
  <div class="bg-white dark:bg-neutral-800 p-5 rounded-lg shadow">
    <h3 class="font-bold mb-3">National Council on Problem Gambling</h3>
    <p class="mb-3">24/7 confidential helpline for problem gamblers and their family members.</p>
    <div class="space-y-2">
      ...
      <div class="flex items-center">
        ...
        <a href="mailto:info@ncpgambling.org" class="text-primary hover:underline">info@ncpgambling.org</a>
      </div>
      <div class="flex items-center">
        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-primary mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 12a9 9 0 01-9 9m9-9a9 9 0 00-9-9m9 9H3m9 9a9 9 0 01-9-9m9 9c1.657 0 3-4.03 3-9s-1.343-9-3-9m0 18c-1.657 0-3-4.03-3-9s1.343-9 3-9m-9 9a9 9 0 019-9" />
        </svg>
        <a href="https://www.ncpgambling.org" class="text-primary hover:underline">www.ncpgambling.org</a>
      </div>
    </div>
  </div>
  
  <div class="bg-white dark:bg-neutral-800 p-5 rounded-lg shadow">
    <h3 class="font-bold mb-3">Gamblers Anonymous</h3>
    <p class="mb-3">A fellowship of men and women who share their experience, strength, and hope to solve their common problem.</p>
    <div class="space-y-2">
      <div class="flex items-center">
        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-primary mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
        </svg>
        <span>1-626-960-3500</span>
      </div>
      <div class="flex items-center">
        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-primary mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 12a9 9 0 01-9 9m9-9a9 9 0 00-9-9m9 9H3m9 9a9 9 0 01-9-9m9 9c1.657 0 3-4.03 3-9s-1.343-9-3-9m0 18c-1.657 0-3-4.03-3-9s1.343-9 3-9m-9 9a9 9 0 019-9" />
